...
| [agentfabric.dev](https://github.com/enzoduit/agentfabric) | agentfabric.dev 官方 MCP 集成，AI 代理可将输出路由给人类审核员，支持审批策略与完整审计跟踪，代理可通过 create_tenant 工具自主注册。 | 官方实现 (agentfabric.dev) 🎖️, 云服务 ☁️, 远程 MCP: mcp.agentfabric.dev, 人机协作审批与审计。 |
